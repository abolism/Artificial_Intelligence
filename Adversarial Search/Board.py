...
class BoardUtility:
    ...
    def score_position(game_board, piece):
        ...
        for c in range(COLS - 3):
            for r in range(ROWS):
                if game_board[r][c] == piece and game_board[r][c + 1] == piece:
                    score += 10

                if game_board[r][c + 1] == piece and game_board[r][c + 2] == piece:
                    score += 10
                if game_board[r][c + 2] == piece and game_board[r][c + 3] == piece:
                    score += 10
        ...
        for r in range(ROWS - 3):
            for c in range(COLS):
                if game_board[r][c] == piece and game_board[r+1][c] == piece:
                    score += 10

                if game_board[r+1][c] == piece and game_board[r+2][c] == piece:
                    score += 10
                if game_board[r+2][c] == piece and game_board[r+3][c] == piece:
                    score += 10
        ...
        for c in range(COLS - 3):
            for r in range(3, ROWS):
                if game_board[r][c] == piece and game_board[r - 1][c + 1] == piece:
                    score += 10
                if game_board[r - 1][c + 1] == piece and game_board[r - 2][c + 2] == piece:
                    score += 10
                if game_board[r - 2][c + 2] == piece and game_board[r - 3][c + 3] == piece:
                    score += 10
    ...
    def is_game_over(self):
        return self.is_terminal_state(self.game_board)
